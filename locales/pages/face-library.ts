...
export const faceLibraryZh = {
  ...
  flowMap: {
    title: "流程圖",
    content: "我們使用流程圖與開發人員和產品經理溝通，確保每個人都知道這個專案包含哪些功能。",
  },
  eventPage: {
    title: "修改事件頁面",
    content: "原本的篩選工具無法完整解釋邏輯。因此我修改了篩選介面，以表達實作背後的意圖。",
  },
  faceManagement: {
    title: "人臉新增/回報",
    content: "根據事件結果的不同，使用者的下一步也會不同。如果結果是未知人員，使用者可以將該人員新增到人臉資料庫。如果使用者發現分析錯誤，也可以更正分析並更新結果到人臉資料庫。",
  },
  mockupFlow: {
    title: "設計稿流程圖",
    content: "最後，我們使用設計稿製作流程圖。一方面可以確保介面的不同狀態都已完成，另一方面開發人員可以了解流程和設計稿之間的關聯。",
  },
}
